...
type CarID = {
    carId: string | null | unknown;
}
export default function UpdateFunction(carId:CarID) {
    console.log("UpdateCarId: ", carId.carId)
    ...
    const UpdateCar = async (carUpdateData: UpdateCarType) => {
        ...
        const response = await fetch(`https://car-nextjs-api.cheatdev.online/cars/${carId.carId}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
    ...
    const handleUpdateCar = async () => {
        ...
        try {
            ...
            setMessage('Car Update successfully!');
            setCarData(result.data);
            console.log('Car updated:', result);
        } catch (error) {
            setError(error instanceof Error ? error.message : 'Failed to update the car');
